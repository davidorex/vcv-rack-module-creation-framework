...
This repo represents a Claude-Code'd transposition of TÂCHES' https://github.com/glittercowboy/plugin-freedom-system to the key of VCV Rack module development. 
